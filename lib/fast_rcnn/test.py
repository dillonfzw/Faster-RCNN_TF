...
def test_net(sess, net, imdb, weights_filename, test_dir, max_per_image=300, thresh=0, vis=False):
    ...
    det_file = os.path.join(test_dir, 'detections.pkl')
    with open(det_file, 'wb') as f:
        cPickle.dump(all_boxes, f, cPickle.HIGHEST_PROTOCOL)

    print 'Evaluating detections'
    mAP, IoU, rec, prec = imdb.evaluate_detections(all_boxes, test_dir)
